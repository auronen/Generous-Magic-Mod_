...
// B_SelectSpell
// -------------
// Magieauswahl fÃƒÂ¼r Menschen und Monster
// Wenn Auswahlkriterien erfÃƒÂ¼llt (je nach Gilde unterschiedlich)
// --> TRUE, sonst FALSE
...
{
	// ------ NpcType_Friend macht hÃƒÂ¶chstens Sleep ------
	...
	&& (slf.aivar[AIV_MagicUser] == MAGIC_ALWAYS)) // Joly: "Mario und seine Freunde", Besessene Menschen (GIL_DMT) mit Nahkampfwaffen.
	{
		...
		return TRUE; // hier immer TRUE zurÃƒÂ¼ckgeben, ansonsten wird in B_SelectWeapon die Waffe wieder weggesteckt
	};
