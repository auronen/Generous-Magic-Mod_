...
func int Spell_Logic_SummonMud(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_SummonMud))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_SummonMud()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_SummonMud);
	};
