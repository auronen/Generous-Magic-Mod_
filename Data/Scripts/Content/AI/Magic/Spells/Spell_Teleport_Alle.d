...
func int Spell_Logic_PalTeleportSecret(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Teleport))
	{
		return SPL_SENDCAST;
	};
...
func void Spell_Cast_PalTeleportSecret()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Teleport);
	};
