...
func int Spell_Logic_EnergyBall(var int manaInvested) // Parameter wird hier nicht gebraucht
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_EnergyBall))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Energyball()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_EnergyBall);
	};
