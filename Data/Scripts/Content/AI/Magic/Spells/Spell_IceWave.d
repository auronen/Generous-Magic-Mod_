...
func int Spell_Logic_IceWave(var int manaInvested) // Parameter wird hier nicht gebraucht
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_IceWave))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_IceWave()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_IceWave);
	};
