...
func int Spell_Logic_MasterOfDisaster(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >=  C_CheckManaCost(self,SPL_Cost_MasterOfDisaster))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_MasterOfDisaster()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] -  C_CheckManaCost(self,SPL_Cost_MasterOfDisaster);	
	};
