...
func int Spell_Logic_DestroyUndead(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_DESTROYUNDEAD))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_DestroyUndead()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_DESTROYUNDEAD);
	};
