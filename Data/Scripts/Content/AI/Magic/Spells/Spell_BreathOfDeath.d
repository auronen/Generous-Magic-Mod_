...
func int Spell_Logic_BreathOfDeath(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_BreathOfDeath))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_BreathOfDeath(var int spellLevel)
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_BreathOfDeath);
	};
