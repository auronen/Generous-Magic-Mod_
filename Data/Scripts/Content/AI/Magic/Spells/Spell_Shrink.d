...
func int Spell_Logic_Shrink(var int manaInvested) // Parameter manaInvested wird hier nicht benutzt
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Shrink))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Shrink()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Shrink);	
	};
