...
func int Spell_Logic_Firebolt(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Firebolt))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Firebolt()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Firebolt);
	};
