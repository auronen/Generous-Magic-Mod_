...
func int Spell_Logic_SummonGolem(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_SummonGolem))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_SummonGolem()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_SummonGolem);
	};
