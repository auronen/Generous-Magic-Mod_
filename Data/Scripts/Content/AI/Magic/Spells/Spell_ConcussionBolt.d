...
func int Spell_Logic_Concussionbolt(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Concussionbolt))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Concussionbolt()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Concussionbolt);
	};
