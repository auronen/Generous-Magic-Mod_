...
func int Spell_Logic_Firerain(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_FireRain))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Firerain()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_FireRain);
	};
