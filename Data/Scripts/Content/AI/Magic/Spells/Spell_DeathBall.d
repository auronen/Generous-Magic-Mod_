...
func int Spell_Logic_Deathball(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Deathball))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Deathball()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Deathball);
	};
