...
func int Spell_Logic_Waterfist(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Waterfist))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Waterfist()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Waterfist);
	};
