...
func int Spell_Logic_PalDestroyEvil(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >=  C_CheckManaCost(self,SPL_Cost_PalDestroyEvil))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_PalDestroyEvil()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] -  C_CheckManaCost(self,SPL_Cost_PalDestroyEvil);	
	};
