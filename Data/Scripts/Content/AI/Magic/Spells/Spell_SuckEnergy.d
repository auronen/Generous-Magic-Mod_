...
func int Spell_Logic_SuckEnergy(var int manaInvested) // Parameter manaInvested wird hier nicht benutzt
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_SuckEnergy))
	{
...
func void Spell_Cast_SuckEnergy()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_SuckEnergy);
	};
