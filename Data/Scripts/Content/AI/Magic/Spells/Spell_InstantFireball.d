...
func int Spell_Logic_InstantFireball(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >=  C_CheckManaCost(self,SPL_Cost_InstantFireball))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_InstantFireball()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] -  C_CheckManaCost(self,SPL_Cost_InstantFireball);	
	};
