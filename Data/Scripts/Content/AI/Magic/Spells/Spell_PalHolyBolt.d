...
func int Spell_Logic_PalHolyBolt(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_PalHolyBolt))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_PalHolyBolt()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_PalHolyBolt);	
	};
