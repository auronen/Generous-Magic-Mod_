...
func int Spell_Logic_Whirlwind(var int manaInvested) // Parameter wird hier nicht gebraucht
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Whirlwind))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Whirlwind()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Whirlwind);
	};
