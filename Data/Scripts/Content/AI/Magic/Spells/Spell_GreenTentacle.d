...
func int Spell_Logic_Greententacle(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Greententacle))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Greententacle()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Greententacle);
	};
