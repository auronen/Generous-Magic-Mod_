...
func int Spell_Logic_Icelance(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Icelance))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Icelance()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Icelance);
	};
