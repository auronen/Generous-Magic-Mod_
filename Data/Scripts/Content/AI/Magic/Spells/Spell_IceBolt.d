...
func int Spell_Logic_IceBolt(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_IceBolt))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_IceBolt()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_IceBolt);
	};
