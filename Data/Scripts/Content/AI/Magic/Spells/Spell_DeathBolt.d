...
func int Spell_Logic_Deathbolt(var int manaInvested)
{
	...
	else if (self.attribute[ATR_MANA] >= C_CheckManaCost(self,SPL_Cost_Deathbolt))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Deathbolt()
{
	...
	{
		self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - C_CheckManaCost(self,SPL_Cost_Deathbolt);
	};
