...
instance ItSe_Addon_Sack(C_Item)
{
	...
	text[0]						= "";											count[0] = 0;
	text[1]						= "";											count[1] = 0;
	text[2]						= "Viele viele bunte Waffen";					count[2] = 0;
};

const string _PRINT_CH_WEAPONS = "Einen Haufen neuer Waffen gefunden!";
func void Use_Sack()
{
...
const string _PRINT_50_LP = "+ 50 Lernpunkte";
...
const string _PRINT_25_LP = "+ 25 Lernpunkte";
...
const string _PRINT_10_LP = "+ 10 Lernpunkte";
...
const string _PRINT_5_LP = "+ 5 Lernpunkte";
...
const string _PRINT_ALL_THIEF_TALENTS = "Alle Diebestalente";
