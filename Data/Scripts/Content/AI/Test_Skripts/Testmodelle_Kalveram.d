...
const string _PRINT_1000_GOLD = "1000 Gold erhalten.";
const string _PRINT_CHEATER = "Cheater Malus: -100 EXP";
func void UseGold()
{
	CreateInvItems(self, ItMi_Gold, 1000);
	PrintScreen(_PRINT_1000_GOLD, -1, 45, FONT_Screen, 2);
	Snd_Play("Geldbeutel");
	PrintScreen(_PRINT_CHEATER, -1, 55, FONT_Screen, 2);
	if (hero.exp >= 100)
	{
...
instance Hosh4(C_ITEM)
{
	...
	text[0]						= "Das Tagebuch von Hoshi";						count[0] = 0;
	text[1]						= "";											count[1] = 0;
	text[2]						= "";											count[2] = 0;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
