...
// ******************************************
	...
	const int BS_AIMFAR									= 25;									// d.h. BogenschÃƒÂ¼tze kann weiterschieÃƒÅ¸en, auch wenn er geschlagen wird
	const int BS_HIT									= 26 | BS_FLAG_INTERRUPTABLE;
	const int BS_PARADE									= 27;

// Magic
	const int BS_CASTING								= 28;									// der Magier kann weiterzaubern, auch wenn er geschlagen wird
...
// Mobsi-Schema-Namen, hier mÃƒÂ¶glichen BodyState zugeordnet
...
// alle Mobs, die hier nicht sind, sind interruptable:
// BOOK,BSANVIL,BSCOOL,BSFIRE,BSSHARP,CAULDRON,DRUM,GRAVE,LAB,ORE,REPAIR
// RMAKER,BAUMSAEGE,STOVE,SDW(Stein des Wissens)
