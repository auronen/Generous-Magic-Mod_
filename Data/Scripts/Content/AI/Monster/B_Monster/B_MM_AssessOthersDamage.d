...
// die die AtitÃƒÂ¼de zum SC auf FRIENDLY gesetzt bekommen
// ****************************************************
...
func void B_MM_AssessOthersDamage()
{
	...
	// ------ wenn ich zu weit weg bin ------ // wichtig fÃƒÂ¼r Aufruf ÃƒÂ¼ber FIGHTSOUND aus ZS_MM_Rtn_Summoned
	...
	if (self.aivar[AIV_PARTYMEMBER] == TRUE)
	{
		...
		&& (!Npc_IsDead(victim))) // Funktion wird auch ÃƒÂ¼ber AssessMurder angesprungen
		{
			Npc_ClearAIQueue(self);
			B_ClearPerceptions(self);
