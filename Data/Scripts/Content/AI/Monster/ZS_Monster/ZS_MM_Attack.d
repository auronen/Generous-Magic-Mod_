...
{												
	...
	// ------ Hilfe anfordern ------
	Npc_SendPassivePerc	(self, PERC_ASSESSWARN,	other, self); //Opfer,TÃƒÂ¤ter	
	...
	self.aivar[AIV_TAPOSITION] = 0; //fÃƒÂ¼r Regeneration
};
...
func int ZS_MM_Attack_Loop ()
{
	...
	else 										// NPC_GetTarget(self) == FALSE, also tot - other hier automatisch gelÃƒÂ¶scht
	{
