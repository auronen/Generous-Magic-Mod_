func void ZS_Stand_RangerMeeting()
{
	...
	Npc_SetPercTime(self, 1); // Damit er ÃƒÂ¶fter reagiert!

	Npc_PercEnable(self, PERC_ASSESSPLAYER, B_AssessGuidePlayer); // Player wird VOR Enemy erfasst! - Geht in ZS_Attack, ZS_ReactToWeapon, B_AssessEnterRoom oder B_AssessTalk // mustte ich noch mal aufrÃƒÂ¶seln)
	...
	|| ((Hlp_GetInstanceID(self)) == (Hlp_GetInstanceID(Greg_NW)))) // Joly:Ja,ja, ich weiÃƒÅ¸. GANZ BÃƒâ€“SE.
	{
