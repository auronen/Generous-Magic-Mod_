...
func int B_AssessEnemy()
{
	...
	// ------- OVERRIDE fÃƒÂ¼r Enemies, die noch vorher quatschen sollen ------
	...
	// ------- Sicherheitsabfrage (B_AssessEnemy wird auch von anderen Funktionen aufgerufen, nicht nur ÃƒÂ¼ber Wahrnehmung) ------
	...
	{
		// ------ ABER ich bin temp_hostile (d.h. hab gerade gegen den Spieler gekÃƒÂ¤mpft) ------
		if ((Npc_GetAttitude(self, other) == ATT_HOSTILE)
		// -------------------------
		...
		// ------ Kampf nur fortsetzen, wenn Spieler nÃƒÂ¤her als 10m ------
