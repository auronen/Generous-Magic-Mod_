...
// und setzt Attack Reason (bzw. ÃƒÂ¼berschreibt ihn evtl.)
// ********************************************************
...
func void B_Attack(var C_Npc slf, var C_Npc oth, var int attack_reason, var int wait)
{
	...
	if (attack_reason == AR_SuddenEnemyInferno)
	{
		...
		Npc_SendPassivePerc(slf, PERC_ASSESSFIGHTSOUND, slf, oth); // EnemyOverride-Aivars von allen anderen Npcs wegschieÃƒÅ¸en!
	};
	...
	// MEMORIZE CRIMES // AR Ãƒâ€žNDERT sich NUR, wenn schwerer als vorheriger (s.o.)
	...
	// ------ AR_KILL ------ // HACK - geht davon aus, daÃƒÅ¸ Spieler auf jeden Fall JETZT stirbt (daher brauchen die Werte spÃƒÂ¤ter nicht resettet zu werden)
	...
	if (!Npc_IsInState(slf, ZS_Talk)) // HIER RAUS: fÃƒÂ¼hrt aus DIA heraus zum LÃƒÂ¶schen des AI_StopProcessInfo
	{
