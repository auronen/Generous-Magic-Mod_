...
func void B_AssessTalk()
{
	...
	// ------ Exit-Conditions NUR fÃƒÂ¼r Monster
	...
	// ------ Exit-Conditions NUR fÃƒÂ¼r Humans ------
	if (self.guild < GIL_SEPERATOR_HUM)
	{
		// ------ Spieler ist Enemy ------
		if (B_AssessEnemy())
	...
	if (C_BodyStateContains(self, BS_SIT))
	{
		...
		{
			// HACK: Im ObservePlayer kann ein NSC sitzen, ohne daÃƒÅ¸ in der END-Routine des ZS sauber aufgestanden wird (klar, denn ZS_ObservePlayer_End hat kein StandUp o.ÃƒÂ¤. - darf dies auch nicht haben)
