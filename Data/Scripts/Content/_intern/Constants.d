...
// ****************************
// Spellkosten fÃƒÂ¼r ALLE SCrolls
// ****************************
const int SPL_Cost_Scroll = 5;

// MH: 19.11.01 Gildennamen geÃƒÂ¤ndert --> Ãƒâ€žnderungen in Text.d (Character-Screen Gildenbezeichnungen) und Species.d (GildenanhÃƒÂ¤ngige Bewegungswerte wie z.B KletterhÃƒÂ¶he)
// MH: 19.11.01 Talente hinzugefÃƒÂ¼gt
// MH: 15.12.01 Neue Spells hinzugefÃƒÂ¼gt
// MH: 15.12.01 Neue Player Talente hinzugefÃƒÂ¼gt
...
const int ATR_STRENGTH = 4; // StÃƒÂ¤rke
...
//	NPC FLAGS
//
const int NPC_FLAG_FRIEND = 1 << 0; // wird nicht benutzt (wird ÃƒÂ¼ber aivar geregelt)
...
//
//	INVENTORY CAPACITIES // --- werden vom Programm ignoriert - INV ist unendlich groÃƒÅ¸! ---
//
...
const int PERC_ASSESSSURPRISE = 30; // wird beim ZurÃƒÂ¼ckverwandeln gesendet
...
//	MISSION STATUS
//
const int LOG_RUNNING = 1; // Mission lÃƒÂ¤uft gerade
...
const int GIL_VLK = 3; // BÃƒÂ¼rger
const int GIL_KDF = 4; // Magier
const int GIL_NOV = 5; // Magier Novize
const int GIL_DJG = 6; // DrachenjÃƒÂ¤ger
const int GIL_SLD = 7; // SÃƒÂ¶ldner
const int GIL_BAU = 8; // Bauer
const int GIL_BDT = 9; // Bandit
const int GIL_STRF = 10; // Prisoner, StrÃƒÂ¤fling
const int GIL_DMT = 11; // Dementoren
const int GIL_OUT = 12; // Outlander (z.B. kleine BauernhÃƒÂ¶fe)

const int GIL_PIR = 13; // Pirat
const int GIL_KDW = 14; // KDW
const int GIL_EMPTY_D = 15; // NICHT VERWENDEN!
// -----------------------------------------------
const int GIL_PUBLIC = 15; // fÃƒÂ¼r ÃƒÂ¶ffentliche PortalrÃƒÂ¤ume
// -----------------------------------------------
...
//	VAR INT JUMPUP_FORCE [GIL_MAX];
	...
	var int FALLDOWN_DAMAGE [GIL_MAX]; // Schaden fÃƒÂ¼r jeden weiteren angefangenen Meter.
...
const int SPL_DONTINVEST = 0; // Es kÃƒÂ¶nnen keine weiteren Manapunkte investiert werden. Erst durch CTRL loslassen geht der Spell ab
const int SPL_RECEIVEINVEST = 1; // Wirkung durchgefÃƒÂ¼hrt, es kÃƒÂ¶nnen weitere Invest kommen, zB.bei Heal nach jedem PÃƒÂ¶ppel
...
const int SPL_NEXTLEVEL = 4; // setze den Spruch auf den nÃƒÂ¤chsten Level
const int SPL_STATUS_CANINVEST_NO_MANADEC = 8;
const int SPL_FORCEINVEST = 1 << 16; // zieht auf jeden Fall einen Manapunkt ab, egal ob timePerMana abgelaufen ist, oder nicht (sinnvoll fÃƒÂ¼r Investierzauber, die zumindest einen Manapunkt abziehen sollen, obwohl timePerMana noch nicht abgelaufen ist.
...
////////////////////////////////////////////////////////////////////////////////
//
//	Spells: AnimationskÃƒÂ¼rzel (Array)
//
...
const int NPC_TALENT_ACROBAT = 11; // --> Anis ÃƒÂ¤ndern!

// NEW Talents // werden komplett auf Scriptebene umgesetzt - Programm braucht sie nur fÃƒÂ¼r Ausgabe im Characterscreen
...
var int PLAYER_TALENT_RUNES[MAX_SPELL]; // Die SPL_ Konstanten werden hierfÃƒÂ¼r als Kennung verwendet
