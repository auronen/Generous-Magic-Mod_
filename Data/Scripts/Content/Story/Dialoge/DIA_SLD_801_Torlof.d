...
func void DIA_Torlof_RUF_Info()
{
	...
	// ------ Duelle ------
	// --------------------
	if (Sld_Duelle_gewonnen >= 3) // geÃƒÂ¤ndert M.F.
	{
		Points_Sld = Points_Sld + 1;

		if (Points_Sld >= 9) // geÃƒÂ¤ndert M.F.
		{
	...
	if (Points_Sld >= 9) // geÃƒÂ¤ndert M.F. // (Maximal 11 - 13 / insgesamt 6 + 3+1 oder 5+1 + 1 fÃƒÂ¼r Duell)
	{
