...
func void DIA_Addon_Saturas_ADWStart_RavenAim()
{
	...
	// AI_Output(self, other, "DIA_Addon_Saturas_ADWStart_RavenAim_14_01"); // Wir wissen es nicht. Es muss etwas sehr Wertvolles oder MÃƒÂ¤chtiges in dem Tempel sein.
	// AI_Output(self, other, "DIA_Addon_Saturas_ADWStart_RavenAim_14_02"); // Aber wir kÃƒÂ¶nnen davon ausgehen, dass er nichts Gutes im Schilde fÃƒÂ¼hrt.
...
func void DIA_Addon_Saturas_BeliarsWeapon_geben()
{
	...
	// AI_Output(self, other, "DIA_Addon_Saturas_BeliarsWeapon_geben_14_01"); // Du bist der Bezwinger des BÃƒÂ¶sen. Deine Entscheidungen bestimmen das Geschick dieser Welt.
	// AI_Output(self, other, "DIA_Addon_Saturas_BeliarsWeapon_geben_14_02"); // Wenn du dich dazu entschlieÃƒÅ¸t, die Klaue aus der Hand zu geben, ist dein Schicksal nicht mehr an sie gebunden.
