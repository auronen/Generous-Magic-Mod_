...
func void DIA_Xardas_FirstEXIT_Info()
{
	...
	B_Kapitelwechsel(1, NEWWORLD_ZEN); // Joly: muÃƒÅ¸ auf jeden Fall hier kommen. Allein schon wegen XP_AMBIENT!
...
func void DIA_Addon_Xardas_StonePlate_Info()
{
	...
	// AI_Output(self, other, "DIA_Addon_Xardas_StonePlate_14_01"); // Ich habe so eine unten in der HÃƒÂ¶hlen vor meinem Turm gefunden.
...
func void DIA_Xardas_PYROWILLNICHT_Info()
{
	...
	// AI_Output(self, other, "DIA_Xardas_PYROWILLNICHT_14_05"); // Jetzt, da ich meinen Turm so nahe der Stadt errichtet habe, muss ich stÃƒÂ¤ndig damit rechnen, dass jemand hierher kommt, um danach zu suchen.
	// "hier" passt nicht, weil Xardas am Steinkreis stehen kÃƒÂ¶nnte - Satz ist eh ÃƒÂ¼berflÃƒÂ¼ssig
