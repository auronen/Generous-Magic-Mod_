...
func void DIA_BDT_1020_Wegelagerer_FirstWarn_Info()
{
	...
	Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "Wieviel willst Du?", DIA_BDT_1020_Wegelagerer_FirstWarn_HowMuch);
	Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "Du machst Witze.", DIA_BDT_1020_Wegelagerer_FirstWarn_Joke);
	Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "Geh mir aus dem Weg!", DIA_BDT_1020_Wegelagerer_PissOff);

	if (MIS_SCHNITZELJAGD == LOG_RUNNING)
	{
		Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "Sag mal, hast du einen Novizen gesehen?", DIA_BDT_1020_Wegelagerer_AGON);
	};
};
...
func void DIA_BDT_1020_Wegelagerer_AGON()
{
	...
	{
		Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "In Ordnung, hier ist dein Geld.", DIA_BDT_1020_Wegelagerer_FirstWarn_GiveMoney);
	};

	Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "Tut mir leid, ich hab kein Geld.", DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney);
	Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "Sieh zu, dass Du verschwindest.", DIA_BDT_1020_Wegelagerer_FirstWarn_Never);
};
...
{
	AI_Output(other, self, "DIA_BDT_1020_Wegelagerer_FirstWarn_GiveMoney_15_00"); //In Ordnung, hier ist dein Geld.
	...
	{
		AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_FirstWarn_GiveMoney_06_02"); //Okay, da ist vor knapp 'ner Stunde so'n Novize vorbeigekommen.
		AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_FirstWarn_GiveMoney_06_03"); //Der hatte es ziemlich eilig und hat sich die ganze Zeit umgesehen. Jetzt verpiss dich.
	};
...
{
	AI_Output(other, self, "DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney_15_00"); //Tut mir Leid, ich hab kein Geld.
	AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney_06_01"); //Jaja, das sind schon schlimme Zeiten.

	if (Npc_HasEquippedMeleeWeapon(other))
	{
		AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney_06_02"); //Aber ich sag dir was, gib mir einfach deine Waffe. Dann lass ich dich durch.

		Info_ClearChoices(DIA_BDT_1020_Wegelagerer_FirstWarn);
		Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "Vergiss es.", DIA_BDT_1020_Wegelagerer_FirstWarn_NoWeapon);
		Info_AddChoice(DIA_BDT_1020_Wegelagerer_FirstWarn, "Hier hast du meine Waffe.", DIA_BDT_1020_Wegelagerer_FirstWarn_GiveWeapon);
	}
	else
	{
...
{
	AI_Output(other, self, "DIA_BDT_1020_Wegelagerer_FirstWarn_Never_15_00"); //Sieh zu, dass du verschwindest.
	AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_FirstWarn_Never_06_01"); //Du willst es wohl auf die harte Tour.
...
{
	AI_Output(other, self, "DIA_BDT_1020_Wegelagerer_FirstWarn_NoWeapon_15_00"); //Vergiss es.
	AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_FirstWarn_NoWeapon_06_01"); //Dann eben auf die harte Tour.
...
{
	AI_Output(other, self, "DIA_BDT_1020_Wegelagerer_FirstWarn_GiveWeapon_15_00"); //Hier hast du meine Waffe.
...
{
	AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_SecondWarn_06_00"); //Du willst es wirklich drauf ankommen lassen. Also wie sieht's aus?

	Info_ClearChoices(DIA_BDT_1020_Wegelagerer_SecondWarn);
	if (Npc_HasItems(other, ItMi_gold) >= 20)
	{
		Info_AddChoice(DIA_BDT_1020_Wegelagerer_SecondWarn, "Hier ist das Geld.", DIA_BDT_1020_Wegelagerer_SecondWarn_GiveMoney);
	};

	Info_AddChoice(DIA_BDT_1020_Wegelagerer_SecondWarn, "Du kriegst keinen Heller von mir.", DIA_BDT_1020_Wegelagerer_SecondWarn_NoMoney);
...
{
	AI_Output(other, self, "DIA_BDT_1020_Wegelagerer_SecondWarn_GiveMoney_15_00"); //Hier ist dein Geld.
	AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_SecondWarn_GiveMoney_06_01"); //Warum denn nicht gleich so?
...
{
	AI_Output(other, self, "DIA_BDT_1020_Wegelagerer_SecondWarn_NoMoney_15_00"); //Du kriegst keinen Heller von mir.
	AI_Output(self, other, "DIA_BDT_1020_Wegelagerer_SecondWarn_NoMoney_06_01"); //Dann werd ich mir den eben holen.
