...
func void DIA_Jora_GHDgInfo_Info()
{
	...
	else
	{
		...
		AI_Output(self, other, "DIA_Jora_Add_08_07"); //There are shady characters who frequent the dockside inn.
...
func void DIA_Jora_BUYAlriksSchwert_Info()
{
	...
	if (B_GiveInvItems(other, self, itmi_gold, 50))
	{
		...
		// AI_Output(self, other, "DIA_Jora_BUYAlriksSchwert_08_03"); // Das kannst du doch immer noch tun - fÃƒÂ¼r 50 GoldstÃƒÂ¼cke ist es deins...
		// Jora_Gold = LOG_SUCCESS;
		// }
		// else
		// {
