...
func void DIA_Akil_Gegend_Onar()
{
	...
	AI_Output(self, other, "DIA_Akil_Gegend_Onar_13_02"); //Irgendwann kommt eine Taverne. Da gehst du weiter nach Osten bis du zu den groÃƒÅ¸en Feldern kommst. Da lungern dann schon die SÃƒÂ¶ldner rum.
	Knows_Taverne = TRUE;
};
...
func void DIA_Akil_Gegend_Wald()
{
	...
	AI_Output(self, other, "DIA_Akil_Gegend_Wald_13_01"); //Da gibt's nur jede Menge Monster - wobei die WÃƒÂ¶lfe noch die ungefÃƒÂ¤hrlichsten sind.
	AI_Output(self, other, "DIA_Akil_Gegend_Wald_13_02"); //Angeblich sollen da auch ein paar Banditen ihre HÃƒÂ¶hle haben. Na - meinen Hof haben sie bis jetzt in Ruhe gelassen.
};

func void DIA_Akil_Gegend_Taverne()
{
	AI_Output(other, self, "DIA_Akil_Gegend_Taverne_15_00"); //Was ist das fÃƒÂ¼r eine Taverne im Osten?
	AI_Output(self, other, "DIA_Akil_Gegend_Taverne_13_01"); //Frag mal Randolph. Er weiÃƒÅ¸ mehr darÃƒÂ¼ber als ich. Er war schon ein paar mal dort.
};
