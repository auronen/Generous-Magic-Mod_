...
func void DIA_Parlan_PETZMASTER_Info()
{
	...
	Parlan_Schulden = 0; // weil Funktion nochmal durchlaufen wird, wenn Crime hÃƒÂ¶her ist...
	...
	if (B_GetGreatestPetzCrime(self) == CRIME_MURDER)
	{
		...
		Parlan_Schulden = Parlan_Schulden + 500; // PLUS MÃƒÂ¶rder-Malus
...
func void DIA_Parlan_Amulett_Info()
{
	...
	AI_Output(self, other, "DIA_Parlan_Amulett_05_02"); //It was created to protect us from the powers of Evil when the time comes.
};
...
///////////////////////////////////////////////////////////////////////
//	SchlÃƒÂ¼ssel fÃƒÂ¼r Bibliothek
///////////////////////////////////////////////////////////////////////
...
func void DIA_Parlan_Kap3U4U5_PERM_Church()
{
	...
	// AI_Output(self,other,"DIA_Parlan_Kap3U4U5_PERM_Church_05_01"); // Die Kirche ist das grÃƒÂ¶ÃƒÅ¸te GebÃƒÂ¤ude im Kloster. Du kannst sie gar nicht ÃƒÂ¼bersehen.
...
func void DIA_Parlan_Kap3U4U5_PERM_Library()
{
	...
	// AI_Output(self,other,"DIA_Parlan_Kap3U4U5_PERM_Library_05_01"); // Die Bibliothek ist am Ende des SÃƒÂ¤ulenganges, direkt gegenÃƒÂ¼ber der Kirche.
...
func void DIA_Parlan_Kap3U4U5_PERM_Chapel()
{
	...
	// AI_Output(self,other,"DIA_Parlan_Kap3U4U5_PERM_Chapel_05_01"); // Wenn du das Kloster betrittst, findest du die Kapelle auf der halben HÃƒÂ¶he des linken SÃƒÂ¤ulenganges.
...
func void DIA_Parlan_Kap3U4U5_PERM_Cellar()
{
	...
	// AI_Output(self,other,"DIA_Parlan_Kap3U4U5_PERM_Cellar_05_01"); // Der Eingang in die Katakomben ist direkt gegenÃƒÂ¼ber der Kapelle auf halber HÃƒÂ¶he des SÃƒÂ¤ulenganges.
