...
func void B_GiveTradeInv_Zuris(var C_Npc slf)
{
	...
	&& (Zuris_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		CreateInvItems(slf, ItMi_ApfelTabak, 2); // fÃƒÂ¼r Abuyin
		CreateInvItems(slf, ItWr_Astronomy_Mis, 1); // FÃƒÂ¼r Mission HygalsBringBook
	...
	&& Zuris_ItemsGiven_Chapter_2 == FALSE)
	{
		...
		CreateInvItems(slf, ItPo_Health_Addon_04, 2);
		CreateInvItems   (slf, ItPo_Mana_Addon_04,		7);
	...
	&& (Zuris_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		CreateInvItems   (slf, ItPo_Mana_Addon_04,		8);
	...
	&& (Zuris_ItemsGiven_Chapter_5 == FALSE))
	{
		...
		CreateInvItems (slf,ItPo_Mana_01 	,60); 
