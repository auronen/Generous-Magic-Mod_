...
func void B_GiveTradeInv_Constantino(var C_Npc slf)
{
	...
	if ((Kapitel >= 2)
	&& Constantino_ItemsGiven_Chapter_2 == FALSE)
	{
	...
	if ((Kapitel >= 3)
	&& (Constantino_ItemsGiven_Chapter_3 == FALSE))
	{
	...
	if ((Kapitel >= 4)
	&& (Constantino_ItemsGiven_Chapter_4 == FALSE))
	{
	...
	if ((Kapitel >= 5)
	&& (Constantino_ItemsGiven_Chapter_5 == FALSE))
	{
