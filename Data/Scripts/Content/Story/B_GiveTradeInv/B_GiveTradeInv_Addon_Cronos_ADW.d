...
func void B_GiveTradeInv_Addon_Cronos_ADW(var C_Npc slf)
{
	...
	if ((Kapitel >= 3)
	&& (Cronos_ADW_ItemsGiven_Chapter_3 == FALSE))
	{
	...
	if ((Kapitel >= 4)
	&& (Cronos_ADW_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		CreateInvItems   (slf, ItPo_Mana_Addon_04,		15);
	...
	if ((Kapitel >= 5)
	&& (Cronos_ADW_ItemsGiven_Chapter_5 == FALSE))
	{
