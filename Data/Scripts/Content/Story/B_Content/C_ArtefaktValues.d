...
C_STR_ArtefaktValue(StÃƒÂ¤rke)

*/
// ------------------------------------------------------------------------------------------
// Check fÃƒÂ¼r Artefakt Set der Heiler (Bonus Berechnung)
// ------------------------------------------------------------------------------------------
func int C_HP_ArtefaktValue()
{
	...
	// fÃƒÂ¼r Diagnose Print(IntToString(HP_Artefakt_Value) );

	return HP_Artefakt_Value;
};

// ------------------------------------------------------------------------------------------
// Check fÃƒÂ¼r Artefakt Set der Priester (Bonus Berechnung)
// ------------------------------------------------------------------------------------------
func int C_MA_ArtefaktValue()
{
	...
	// fÃƒÂ¼r Diagnose Print(IntToString(MA_Artefakt_Value) );

	return MA_Artefakt_Value;
};

// ------------------------------------------------------------------------------------------
// Check fÃƒÂ¼r Artefakt Set der Krieger (Bonus Berechnung)
// ------------------------------------------------------------------------------------------
