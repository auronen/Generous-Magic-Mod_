...
func void B_MakeRangerReadyToLeaveMeeting(var C_Npc Ranger)
{
	...
	AI_EquipBestArmor(Ranger); // Joly:ITAR_Fake_RANGER wegen diesem hier, falls die Armor nicht gelÃƒÂ¶scht wurde.
};
...
func void B_RangerMeetingParking() // im Lares dialog
{
	if (MIS_Addon_Cavalorn_GetOrnamentFromPAL != 0)
	{
		B_StartOtherRoutine(Cavalorn, "Stadt"); // Joly:nicht parking. Der plÃƒÂ¶ppt sonst bei Vat vat rein.
	};
