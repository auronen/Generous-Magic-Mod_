...
//	func void b_enter_newworld_kapitel_1
{
	...
	// - ---- Gefangene in Addonworld tÃƒÂ¶ten und neue in Newworld---------
...
func void B_ENTER_NEWWORLD_Kapitel_2()
{
	...
	if (EnterNW_Kapitel2 == FALSE)
	{
		...
		Wld_InsertNpc(Gobbo_Green, "NW_BIGFARM_LAKE_MONSTER_05_01");
		Wld_InsertNpc(Gobbo_Green, "NW_BIGFARM_LAKE_MONSTER_05_01");
		// Joly:Xardas Secret-Area (gegenÃƒÂ¼ber vom Turm in den Bergen.)
...
func void B_ENTER_NEWWORLD_Kapitel_4()
{
	if (EnterNW_Kapitel4 == FALSE)
	{
		...
		//***********GILDEN_UN_ABHÃƒâ€žNGIG*****************************************
		// Joly: Dienen nur als Hint fÃƒÂ¼r Spieler, dieÃ‚Â´s raffen und sich ÃƒÂ¼ber die "strangen" Sachen wundern, die fÃƒÂ¼r andere Gilden bestimmt sind!!
		...
		//***********GILDENABHÃƒâ€žNGIG*****************************************
		// AntiPaladine fÃƒÂ¼r den Paladin
...
func void B_ENTER_NEWWORLD_Kapitel_5()
{
	if (EnterNW_Kapitel5 == FALSE)
	{
		...
		Wld_InsertNpc(NONE_101_Mario, "NW_CITY_ENTRANCE_01"); // Mario, Seesoldat fÃƒÂ¼rs 6. Kapitel (BÃƒÂ¶sewicht)
...
// ******************************************************************************************************************************************************************
// B_ENTER_NEWWORLD (wird ÃƒÂ¼ber INIT_NEWWORLD in der NW beim Betreten aufgerufen (Beispiel: fÃƒÂ¼r DJG, die erst nach dem 1.Betreten der OW eingesetzt werden))
// ******************************************************************************************************************************************************************
