...
func int B_TeachAttributePoints(var C_Npc slf, var C_Npc oth, var int attrib, var int points, var int teacherMAX)
{
	...
	// ------ Lernen NICHT ÃƒÂ¼ber teacherMax ------
	var int realAttribute;
if (attrib == ATR_STRENGTH)	{ realAttribute = oth.attribute[ATR_STRENGTH]; } // Umwandeln von const-Parameter in VAR fÃƒÂ¼r folgende if-Abfrage
	...
	if (realAttribute >= teacherMAX) // Wenn der Spieler schon das teacherMAX erreicht oder ÃƒÂ¼berschritten hat
	{
