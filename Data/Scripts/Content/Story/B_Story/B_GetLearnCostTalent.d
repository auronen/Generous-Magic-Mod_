...
func int B_GetLearnCostTalent(var C_Npc oth, var int talent, var int skill)
{
	...
	if (talent == NPC_TALENT_RUNES)
	{
		...
		// 5
		else if (skill == SPL_Firestorm) { kosten = (10); }
		else if (skill == SPL_IceWave) { kosten = (10); }
		else if (skill == SPL_SummonDemon) { kosten = (10); }
		else if (skill == SPL_FullHeal) { kosten = (10); }
		else if (skill == SPL_MasterOfDisaster) { kosten = (10); }
		// 6
		else if (skill == SPL_Firerain) { kosten = (10); }
		else if (skill == SPL_BreathOfDeath) { kosten = (10); }
