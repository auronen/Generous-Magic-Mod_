...
class C_SVM
{
	...
	var string MILGreetings;																	// Miliz grÃƒÂ¼ÃƒÅ¸t Miliz oer Paladin
	var string PALGreetings;																	// Paladin grÃƒÂ¼ÃƒÅ¸t Paladin oder Magier
	var string Weather;																			// So ein Mistwetter!

	// ------ B_Say_AttackReason ------
	var string IGetYouStill;																	// Upset-NSC sieht Spieler wÃƒÂ¤hrned seiner Angry-Time wieder. Greift mit altem AttackReason an.
	var string DieEnemy;																		// Feind wird angegriffen
	var string DieMonster;																		// gefÃƒÂ¤hrliches Monster wird angegriffen
	...
	var string DieStupidBeast;																	// Torwachen schlagen ungefÃƒÂ¤hliches Monster tot, das versucht durchs Tor zu gehen
	...
	var string WillYouStopFighting;																// Wache beendet Kampf, greift TÃƒÂ¤ter an

	// ------ B_Say_AttackEND ------
	var string KillEnemy;																		// Finishing-Move
	var string EnemyKilled;																		// NSC hat Feind getÃƒÂ¶tet
	var string MonsterKilled;																	// NSC hat gefÃƒÂ¤hrliches Monster getÃƒÂ¶tet
	...
	var string KillMurderer;																	// MÃƒÂ¶rder finishen
	var string StupidBeastKilled;																// GateGuards tÃƒÂ¶ten neutrales Monster, das vorbeikam
	...
	var string ThereIsNoFightingHere;															// Wache hat TÃƒÂ¤ter einer SchlÃƒÂ¤gerei (derjenige, der angefangen hat) niedergeschlagen

	// ------ C_WantToFlee ------
	var string SpareMe;																			// Tu mir nichts!
	var string RunAway;																			// ScheiÃƒÅ¸e! Nichts wie weg!

	// ------ C_WantToCallGuardsForFight ------
	var string Alarm;																			// Wache ruft Wache
	var string Guards;																			// Harter Bursche ruft Wache
	var string Help;																			// BÃƒÂ¼rger ruft Hilfe

	// ------ B_AssessMurder ------
	var string GoodMonsterKill;																	// Monster getÃƒÂ¶tet - NSC findet das toll
	var string GoodKill;																		// Mensch getÃƒÂ¶tet - NSC findet das toll (war sein Feind)
	...
	var string YesGoOutOfHere;																	// Spieler verlÃƒÂ¤ÃƒÅ¸t verboten Raum artig wieder
	...
	var string OhMyGodItsAFight;																// NSC entdeckt einen Kampf, und findet das bestÃƒÂ¼tzend (BÃƒÂ¼rger)
	...
	var string OhMyGodHesDown;																	// BestÃƒÂ¼rzung ÃƒÂ¼ber brutales Niederschlagen
	...
	var string Awake;																			// NSC wacht aus dem Zustand Sleep wieder auf (Aufwachen, rÃƒÂ¤keln)

	// ------ B_AssignAmbientNEWS ------
	var string ABS_COMMANDER;																	// Ich hÃƒÂ¶rte, du warst beim Kommandanten und hast die Sache wieder in Ordnung gebracht.
	var string ABS_MONASTERY;																	// Ich hÃƒÂ¶rte, du warst bei Vater Parlan und hast BuÃƒÅ¸e getan.
	var string ABS_FARM;																		// Ich hÃƒÂ¶rte, du warst bei Lee und und hast die Sache wieder in Ordnung gebracht.
	var string ABS_GOOD;
	// ---------------------------------
	var string SHEEPKILLER_CRIME;																// Einfach unsere Schafe zu schlachten! Mach, daÃƒÅ¸ du hier wegkommst!
	var string ATTACK_CRIME;																	// Mit miesen SchlÃƒÂ¤gern rede ich nicht!
	var string THEFT_CRIME;																		// Geh mir aus den Augen, dreckiger Dieb!
	var string MURDER_CRIME;																	// Mit gemeinen MÃƒÂ¶rdern rede ich nicht.
	// ---------------------------------
	var string PAL_CITY_CRIME;																	// Du bist eine Schande fÃƒÂ¼r deinen Orden! Lord Hagen wird toben vor Wut!
	var string MIL_CITY_CRIME;																	// Du bist eine Schande fÃƒÂ¼r die Stadtwache! Lord Andre wird dir das sicher austreiben!
	...
	// ------ GOLD ------
	var string GOLD_1000;																		// 1000 GoldstÃƒÂ¼cke.
	var string GOLD_950;																		// 950 GoldstÃƒÂ¼cke.
	var string GOLD_900;																		// 900 GoldstÃƒÂ¼cke.
	var string GOLD_850;																		// 850 GoldstÃƒÂ¼cke.
	var string GOLD_800;																		// 800 GoldstÃƒÂ¼cke.
	var string GOLD_750;																		// 750 GoldstÃƒÂ¼cke.
	var string GOLD_700;																		// 700 GoldstÃƒÂ¼cke.
	var string GOLD_650;																		// 650 GoldstÃƒÂ¼cke.
	var string GOLD_600;																		// 600 GOldstÃƒÂ¼cke.
	var string GOLD_550;																		// 550 GoldstÃƒÂ¼cke.
	var string GOLD_500;																		// 500 GoldstÃƒÂ¼cke.
	var string GOLD_450;																		// 450 GoldstÃƒÂ¼cke.
	var string GOLD_400;																		// 400 GoldstÃƒÂ¼cke.
	var string GOLD_350;																		// 350 GoldstÃƒÂ¼cke.
	var string GOLD_300;																		// 300 GoldstÃƒÂ¼cke.
	var string GOLD_250;																		// 250 GoldstÃƒÂ¼cke.
	var string GOLD_200;																		// 200 GoldstÃƒÂ¼cke.
	var string GOLD_150;																		// 150 GoldstÃƒÂ¼cke.
	var string GOLD_100;																		// 100 GoldstÃƒÂ¼cke.
	var string GOLD_90;																			// 90 GoldstÃƒÂ¼cke.
	var string GOLD_80;																			// 80 GoldstÃƒÂ¼cke.
	var string GOLD_70;																			// 70 GoldstÃƒÂ¼cke.
	var string GOLD_60;																			// 60 GoldstÃƒÂ¼cke.
	var string GOLD_50;																			// 50 GoldstÃƒÂ¼cke.
	var string GOLD_40;																			// 40 GoldstÃƒÂ¼cke.
	var string GOLD_30;																			// 30 GoldstÃƒÂ¼cke.
	var string GOLD_20;																			// 20 GoldstÃƒÂ¼cke.
	var string GOLD_10;																			// 10 GoldstÃƒÂ¼cke.
	...
	var string Smalltalk06;																		// ...war doch klar, daÃƒÅ¸ das Ãƒâ€žrger gibt...
	var string Smalltalk07;																		// ...aber behalt's fÃƒÂ¼r Dich, muÃƒÅ¸ nicht gleich jeder wissen...
	var string Smalltalk08;																		// ...das passiert mir nicht nochmal...
	var string Smalltalk09;																		// ...an der Gechichte muÃƒÅ¸ wohl doch was dran sein...
	var string Smalltalk10;																		// ...man muÃƒÅ¸ eben aufpassen was man rumerzÃƒÂ¤hlt...
	var string Smalltalk11;																		// ...solange ich damit nichts zu tun habe...
	var string Smalltalk12;																		// ...man darf auch nicht alles glauben, was man hÃƒÂ¶rt...
	...
	var string Smalltalk16;																		// ...frÃƒÂ¼her wÃƒÂ¤re das ganz anders gelaufen...
	var string Smalltalk17;																		// ...gequatscht wird viel...
	var string Smalltalk18;																		// ...ich hÃƒÂ¶r nicht mehr auf das Gefasel...
	var string Smalltalk19;																		// ...verlaÃƒÅ¸ Dich auf jemanden und Du bist verlassen, das ist eben so...
	var string Smalltalk20;																		// ...ich glaube kaum, daÃƒÅ¸ sich daran was ÃƒÂ¤ndern wird...
	var string Smalltalk21;																		// ...wahrscheinlich hast Du recht...
	var string Smalltalk22;																		// ...erstmal abwarten. Es wird nichts so heiÃƒÅ¸ gegessen, wie es gekocht wird...
	var string Smalltalk23;																		// ...ich dachte, das wÃƒÂ¤re schon lange geklÃƒÂ¤rt, aber das ist wohl nicht so...
	var string Smalltalk24;																		// ...laÃƒÅ¸ uns lieber ÃƒÂ¼ber was anderes reden...
	...
	var string Smalltalk30;																		// ...niemand darf gegen die gÃƒÂ¶ttliche Ordnung verstoÃƒÅ¸en...

	// ------ Lehrer-Kommentare ------
	var string NoLearnNoPoints;																	// NSC-Lehrer verbietet Steigerung - keine Lernpunkte!
	var string NoLearnOverPersonalMAX;															// NSC-Lehrer verbietet Steigerung ÃƒÅ“BER sein persÃƒÂ¶nliches Lehrer-Maximum
	...
	// ------ Kampf ------
	var string Dead;																			// TÃƒÂ¶dlich verletzt
	...
	var string ADDON_WRONGARMOR;																// Sc hat unangemessene RÃƒÂ¼stung an // Default
	var string ADDON_WRONGARMOR_SLD;															// Beide SLD/DJG und falsche RÃƒÂ¼stung
	var string ADDON_WRONGARMOR_MIL;															// Beide MIL/PAL und falsche RÃƒÂ¼stung
	var string ADDON_WRONGARMOR_KDF;															// Beide KDF und falsche RÃƒÂ¼stung
	var string ADDON_NOARMOR_BDT;																// self ist BAndite und SC hat keine RÃƒÂ¼stung an.
...
// NSCs
// ----
// SVMs mÃƒÂ¼ssen immer "SVM_x" heissen,
...
instance SVM_3(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_3_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_4(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_4_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_5(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_5_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_6(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_6_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_7(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_7_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_8(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_8_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_9(C_SVM)
{
	...
	// MonsterKilled									= "SVM_9_MonsterKilled";				// Ich steh' auf diese ganze ScheiÃƒÅ¸e!
	...
	TEMPEL_2_GALGEN										= "SVM_9_TEMPEL_2_GALGEN";				//If you pass the tavern on the left when you're coming from the temple, you'll come out at the gallows square.
...
instance SVM_10(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_10_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_11(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_11_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_12(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_12_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_13(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_13_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_14(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_14_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_16(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_16_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
...
instance SVM_17(C_SVM)
{
	...
	TEMPEL_2_GALGEN										= "SVM_17_TEMPEL_2_GALGEN";				//Coming from the temple, if you pass the tavern on the left, you'll come out at the gallows square.
