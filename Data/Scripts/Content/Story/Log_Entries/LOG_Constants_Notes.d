...
const string TOPIC_Trader_OC_2				= "Tandor handelt mit Waffen in der Burg.";
const string TOPIC_Trader_OC_3				= "Tandor handelt mit Waffen in der Burg.";
const string TOPIC_Trader_OC_4				= "Engor verwaltet die Vorräte der Burg und macht nebenher Geschäfte.";
const string TOPIC_Trader_OC_5				= "Tandor handelt mit Waffen in der Burg.";
...
const string Topic_OutTrader_1				= "Rosi handelt mit verschiedenen Waren, auf dem Hof von Sekob.";
...
const string TOPIC_Teacher_OC_6				= "Keroloth trainiert Schwertkampf in der Burg.";
...
const string TOPIC_CityTeacher_2			= "Constantino kann mich in der Kunst der Alchemie unterweisen.";
...
const string Topic_CityTeacher_10			= "Lares kann mir dabei helfen, geschickter und stärker zu werden.";
...
const string TOPIC_Addon_KDWTeacher_1		= "Merdarion kann mein Mana steigern.";
...
const string TOPIC_TalentSmith_4			= "Um eine Waffe zu schmiede, brauche ich zunächst ein Stück Rohstahl. An einem Schmiedefeuer muss ich den Stahl erhitzen und anschließend an einem Amboss in die gewünschte Form bringen. Für hochwertigere Waffe benötigt man häufig noch Substanzen, welche der Waffe besondere Eigenschaften verleihen.";
...
const string TOPIC_TalentSmith_12			= "Wenn ich 4 Erz und 5 Drachenblut hinzugebe, kann ich mir einen ´ERZ-DRACHENTÖTER´ schmieden.";
const string TOPIC_TalentSmith_13			= "Wenn ich 5 Erz und 5 Drachenblut hinzugebe, kann ich mir einen ´GROßEN ERZ-DRACHENTÖTER´ schmieden.";
const string TOPIC_TalentSmith_14			= "Ich kann jetzt ein edles Schwert schmieden.";
const string TOPIC_TalentSmith_15			= "Ich kann jetzt auch ein edles Langschwert schmieden.";
const string TOPIC_TalentSmith_16			= "Ich kann jetzt sogar eine Rubinklinge schmieden.";
const string TOPIC_TalentSmith_17			= "Harad hat mir beigebracht, 'El Bastardo' zu schmieden - eine der besten Einhandwaffen, die es gibt!";

const string TOPIC_TalentRunes				= "Die Runen";
const string TOPIC_TalentRunes_1			= "Zutaten für die Rune ´Heiliges Geschoss´: 1 geweihtes Wasser, aber keine Spruchrolle";
const string TOPIC_TalentRunes_2			= "Um eine Rune zu erschaffen, benötige ich für jede Rune unterschiedliche Zutaten. Mit diesen Zutaten und einem Runenrohling kann ich dann die gewünschte Rune am Runentisch erschaffen.";
const string TOPIC_TalentRunes_3			= "Zutaten für die Rune ´Geheimer Teleport´: 1 Geweihtes Wasser";
const string TOPIC_TalentRunes_4			= "Um eine Rune zu erschaffen, benötige ich, neben der Spruchrolle des gewünschten Spruches, für jede Rune unterschiedliche Zutaten. Mit diesen Zutaten und einem Runenrohling kann ich dann die gewünschte Rune am Runentisch erschaffen.";
const string TOPIC_TalentRunes_5			= "Zutaten für die Rune ´LICHT´: 1 Goldmünze.";
const string TOPIC_TalentRunes_6			= "Zutaten für die Rune ´FEUERPFEIL´: 1 Schwefel.";
const string TOPIC_TalentRunes_7			= "Zutaten für die Rune ´EISPFEIL´: 1 Gletscherquartz";
const string TOPIC_TalentRunes_8			= "Zutaten für die Rune ´LEICHTE WUNDEN HEILEN´:1 Heilpflanze.";
const string TOPIC_TalentRunes_9			= "Zutaten für die Rune ´GOBLINSKELETT ERSCHAFFEN´:1 Goblinknochen.";
const string TOPIC_TalentRunes_10			= "Zutaten für die Rune ´FEUERBALL ´: 1 Pech";
const string TOPIC_TalentRunes_11			= "Zutaten für die Rune ´BLITZ`:1 Bergkristall.";
const string TOPIC_TalentRunes_12			= "Zutaten für die Rune ´WOLF RUFEN´: 1 Wolfsfell.";
const string TOPIC_TalentRunes_13			= "Zutaten für die Rune ´WINDFAUST´:1 Stück Kohle.";
const string TOPIC_TalentRunes_14			= "Zutaten für die Rune ´SCHLAF`:1 Sumpfkraut. Auch eine Methode das Zeug zu verwenden.";
const string TOPIC_TalentRunes_15			= "Zutaten für die Rune ´MITTLERE WUNDEN HEILEN´:1 Heilkraut.";
const string TOPIC_TalentRunes_16			= "Zutaten für die Rune ´BLITZSCHLAG´: 1 Bergkristall und 1 Gletscher Quartz.";
const string TOPIC_TalentRunes_17			= "Zutaten für die Rune ´GROSSER FEUERBALL´: 1 Schwefel und 1 Pech.";
const string TOPIC_TalentRunes_18			= "Zutaten für die Rune ´SKELET BESCHWÖREN´: 1 Skelettknochen.";
const string TOPIC_TalentRunes_19			= "Zutaten für die Rune ´ANGST´: 1 schwarze Perle.";
const string TOPIC_TalentRunes_20			= "Zutaten für die Rune ´EISBLOCK´: 1 Gletscher Quartz und 1 Aquamarin.";
const string TOPIC_TalentRunes_21			= "Zutaten für die Rune ´KUGELBLITZ´: 1 Schwefel und 1 Bergkristall.";
const string TOPIC_TalentRunes_22			= "Zutaten für die Rune `STEINGOLEM ERSCHAFFEN`:1 Steingolemherz.";
const string TOPIC_TalentRunes_23			= "Zutaten für die Rune ´UNTOTE VERNICHTEN´:1 heiliges Wasser .";
const string TOPIC_TalentRunes_24			= "Zutaten für die Rune `GROSSER FEUERSTURM´: 1 Schwefel und 1 Zunge eines Feuerwarans.";
const string TOPIC_TalentRunes_25			= "Zutaten für die Rune ´FEUERSTURM´: 1 Schwefel und 1 Pech.";
const string TOPIC_TalentRunes_26			= "Zutaten für die Rune ´EISWELLE´: 1 Gletscher Quartz und 1 Aquamarin";
const string TOPIC_TalentRunes_27			= "Zutaten für die Rune ´DÄMON BESCHWÖREN´: 1 Dämonenherz";
const string TOPIC_TalentRunes_28			= "Zutaten für die Rune ´SCHWERE WUNDEN HEILEN´ 1 Heilwurzel";
const string TOPIC_TalentRunes_29			= "Zutaten für die Rune ´FEUERREGEN´: 1 Pech und eine Zunge von einem Feuerwaran";
const string TOPIC_TalentRunes_30			= "Zutaten für die Rune ´TODESHAUCH´: 1 Kohle und 1 schwarze Perle";
const string TOPIC_TalentRunes_31			= "Zutaten für die Rune ´MASSENTOD´: 1 Skelettknochen und 1 schwarze Perle";
const string TOPIC_TalentRunes_32			= "Zutaten für die Rune ´ARMEE DER FINSTERNIS´: 1 Skelettknochen, 1 schwarze Perle, 1 Herz eines Steingolems und 1 Dämonenherz. ";
const string TOPIC_TalentRunes_33			= "Zutaten für die Rune ´MONSTER SCHRUMPFEN´: 1 Goblinknochen und 1 Trollzahn";

const string TOPIC_TalentAlchemy			= "Die Tränke";
const string TOPIC_TalentAlchemy_1			= "Um einen Heiltrunk herzustellen, benötige ich 1 Feldknöterich und 3 Essenzen der Heilung.";
const string TOPIC_TalentAlchemy_2			= "Um einen Manatrunk herzustellen, benötige ich 1 Feldknöterich und 3 Mana - Essenzen.";
...
const string TOPIC_TalentAnimalTrophy_1		= "Ich kann jetzt:";
...
const string TOPIC_TalentAnimalTrophy_5		= "...Reptilien häuten.";
...
const string TOPIC_TalentMagicCircle_1		= "Die mir zugängliche magischen Runen sind in Kreise eingeteilt. Einen Spruch mit einem höheren Kreis als ich gemeistert habe, kann ich nicht verwenden.";
const string TOPIC_TalentMagicCircle_2		= "Die Sprüche des 1. Kreises sind: Licht, Feuerpfeil, Kleiner Blitz, leichte Wunden heilen und Goblin Skelett beschwören.";
const string TOPIC_TalentMagicCircle_3		= "Die Sprüche des 2. Kreises sind: Feuerball, Eispfeil, Wolf rufen, Windfaust und Schlaf";
const string TOPIC_TalentMagicCircle_4		= "Die Sprüche des 3. Kreises sind: mittlere Wunden heilen, Kugelblitz ,Kleiner Feuersturm, Skelett erschaffen, Angst und Eisblock";
const string TOPIC_TalentMagicCircle_5		= "Die Sprüche des 4. Kreises sind: Blitzschlag, Steingolem erschaffen, Untote vernichten und Grosser Feuerball.";
const string TOPIC_TalentMagicCircle_6		= "Die Sprüche des 5. Kreises sind: Grosser Feuersturm, Eiswelle ,Dämon beschwören und schwere Wunden heilen.";
const string TOPIC_TalentMagicCircle_7		= "Die Sprüche des 6. Kreises sind: Feuerregen, Todeshauch, Todeswelle, Armee der Finsternis und Monster schrumpfen.";

const string TOPIC_WispDetector				= "Das suchende Irrlicht";
const string TOPIC_Language					= "Die Sprache der Erbauer";

// ------ Sonstiges ------
const string Topic_Bonus					= "Besonderes"; // z.B. täglich essen abholen...
...
const string Topic_Diebesgilde_1			= "Ich bin in die Diebesgilde aufgenommen worden.";
const string Topic_Diebesgilde_2			= "Ich kenne das Zeichen der Diebe. Wenn ich das den richtigen Leuten zeige, wissen sie das ich dazugehöre. ";
const string Topic_Diebesgilde_3			= "Halvor kauft mir silberne Teller und Kelche zu einem besseren Preis als jeder andere Händler ab.";
