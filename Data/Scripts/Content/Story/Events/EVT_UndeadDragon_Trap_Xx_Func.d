...
func void EVT_UNDEADDRAGON_TRAP_01_FUNC()
{
	if (EVT_UNDEADDRAGON_TRAP_01_FUNC_COUNT_NoMore < 10) // Joly:kein Exploid
	{
		...
		&& (EVT_UNDEADDRAGON_TRAP_01_FUNC_COUNT != 0)) // Joly: beim ersten Ãƒâ€“ffnen -> Kein Ork, denn es gibt schon einen ersten per Startup
		{
		...
		if (EVT_UNDEADDRAGON_TRAP_01_FUNC_COUNT > 2) // Joly:jedes 2. Ãƒâ€“ffnen macht einen Ork
		{
...
func void EVT_UNDEADDRAGON_TRAP_02_FUNC()
{
	if (EVT_UNDEADDRAGON_TRAP_02_FUNC_COUNT_NoMore < 10) // Joly:kein Exploid
	{
		...
		&& (EVT_UNDEADDRAGON_TRAP_02_FUNC_COUNT != 0)) // Joly: beim ersten Ãƒâ€“ffnen -> Kein Ork, denn es gibt schon einen ersten per Startup
		{
		...
		if (EVT_UNDEADDRAGON_TRAP_02_FUNC_COUNT > 2) // Joly:jedes 2. Ãƒâ€“ffnen macht einen Ork
		{
...
func void EVT_UNDEADDRAGON_TRAP_03_FUNC()
{
	if (EVT_UNDEADDRAGON_TRAP_03_FUNC_COUNT_NoMore < 10) // Joly:kein Exploid
	{
		...
		&& (EVT_UNDEADDRAGON_TRAP_03_FUNC_COUNT != 0)) // Joly: beim ersten Ãƒâ€“ffnen -> Kein Ork, denn es gibt schon einen ersten per Startup
		{
		...
		if (EVT_UNDEADDRAGON_TRAP_03_FUNC_COUNT > 2) // Joly:jedes 2. Ãƒâ€“ffnen macht einen Ork
		{
