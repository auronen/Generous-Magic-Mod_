...
// Die Funktionen mÃƒÂ¼ssen so heissen wie die zen-files
// *******************************************************************
...
func void STARTUP_ADDON_PART_GOLDMINE_01()
{
	...
	// ------------ Monster ANZAHL (10) WICHTIG fÃƒÂ¼r Garaz (FIXME_FILLER) ----------------------------
...
func void STARTUP_ADDON_PART_ENTRANCE_01()
{
	...
	Wld_InsertNpc(VLK_4304_Addon_William, "ADW_ENTRANCE"); // Unterhalpb des HÃƒÂ¼gels, auf der PIR Seite
...
func void STARTUP_ADDON_PART_BANDITSCAMP_01()
{
	...
	Wld_InsertNpc(BDT_1077_Addon_Bandit, "BANDIT"); // EX HÃƒÂ¤ndler
	...
	Wld_InsertNpc(BDT_1097_Addon_Fisk, "BANDIT"); // HÃƒÂ¤ndler
...
{
	// Die portalrÃƒÂ¤ume im banditenlager
...
{
	// --------- Piraten --------------------------
	Wld_InsertNpc(PIR_1350_Addon_Francis, "STRAND"); // Vor Gregs HÃƒÂ¼tte -->SitBench
	Wld_InsertNpc(PIR_1351_Addon_Samuel, "STRAND"); // In der HÃƒÂ¶hle
	Wld_InsertNpc(PIR_1353_Addon_Morgan, "STRAND"); // Vor Sams HÃƒÂ¶hle
	...
	Wld_InsertNpc(PIR_1367_Addon_Owen, "STRAND"); // HolzfÃƒÂ¤lelrlager
	Wld_InsertNpc(PIR_1368_Addon_Malcom, "STRAND"); // tot ind er geheimen HÃƒÂ¶hle
	...
	Wld_InsertItem(ItAm_Addon_STR, "FP_ITEMSPAWN_LONEBEACH_02"); // -->Feuerwaranstrand in der HÃƒÂ¶hle
/*

	// -------- Sonstige Item FP ------------

	Wld_InsertItem(XXX, "FP_ITEMSPAWN_WATERHOLE_01"); // -->Hinten im Talkessel mit dem See
	Wld_InsertItem(XXX, "FP_ITEMSPAWN_SECRETCAVE_01"); // -->In der unterirdische StunthÃƒÂ¶hle
	...
	Wld_InsertItem(XXX, "FP_ITEMSPAWN_BEACH_02"); // -->Piratenstrand, hinter der ersten HÃƒÂ¼tte
	...
	Wld_InsertItem(XXX, "FP_ITEMSPAWN_LURKERBEACH_03"); // -->Lurkerstrand HÃƒÂ¶hle
...
func void INIT_SUB_OLDCAMP()
{
	...
	// ------ PORTAL-RÃƒâ€žUME ------ // GroÃƒÅ¸- und Kleinschreibung beachten!

	// Wld_AssignRoomToGuild("hÃƒÂ¼tte77",GIL_VLK);
	...
	// Brutus
	Wld_AssignRoomToGuild("tu1", GIL_NONE); // wegen Mission besser gil_none (lÃƒÂ¤uft raus)

	// WehrgÃƒÂ¤nge
	Wld_AssignRoomToGuild("he3", GIL_NONE); // einzelner Raum ÃƒÂ¼ber Knast
	...
	Wld_AssignRoomToGuild("hh3", GIL_PUBLIC); // KÃƒÂ¼che
...
//*******************************************************
	...
	// -------------JÃƒÂ¤ger Camp im Lager ÃƒÂ¼ber ehem. Cavalorns HÃƒÂ¼tte---------------------------
	...
	// -------------HÃƒÂ¶hle von Cavalorns HÃƒÂ¼tte---------------------------
	Wld_InsertNpc(PAL_217_Marcos, "OC1");

	// -------------Entflohene StrÃƒÂ¤flinge im spÃƒÂ¤teren DJG Vorposten Camp---------------------------------------------------------
	...
	Wld_InsertNpc(VLK_4110_Jergan, "OC1"); // SpÃƒÂ¤her
...
//*******************************************************
	...
	// hinter der BrÃƒÂ¼cke gegenÃƒÂ¼ber der verlassenen Mine
	...
	// zwischen ehem. Ratford und BrÃƒÂ¼cke zum OC
	...
	// entschÃƒÂ¤fter alternativ Weg zur Newmine
...
// ------------------ nahe der NewMine ------------------
	...
	// Bei eingestÃƒÂ¼rtzter OrcbrÃƒÂ¼cke
...
// --------------------------------------------------------------------------
	...
	*/
	...
	// ------------------Mine 2 zu Banditenlager Die BrÃƒÂ¼cken--------------------------
	...
	// ehem. Neks HÃƒÂ¶hle, Gothic2 Gorns Versteck----------------
	...
	// HÃƒÂ¶hle unter Wasserfall nahe Iceregion
	...
	// ######################################################################
	//	 bei alter GobbohÃƒÂ¶hle: Orclager
	// ######################################################################
	...
	// umgestÃƒÂ¼rtzter DemonenbeschwÃƒÂ¶rer Turm im Wasser
	...
	// HÃƒÂ¶hle auf Bergweg vor Milten NÃƒÂ¤he Stonehenge
	...
	Wld_InsertNpc(SkeletonMage_Angar, "OW_UNDEAD_DUNGEON_03"); // Joly: in der HÃƒÂ¶hle
	...
	// Berggebiet vor BrÃƒÂ¼cke (ehemaliges Bloodhound-gebiet)
	...
	// --------ITEMS in den vergessenen HÃƒÂ¶hlen/Locations -----------------
...
func void INIT_OLDWORLD()
{
	...
	if ((MIS_ReadyForChapter4 == TRUE) // Joly: muÃƒÅ¸ hier in der INIT ganz zum schluss stehen, nachdem alle NSCs fÃƒÂ¼rs Kapitel insertet wurden!!!
...
func void STARTUP_NewWorld_Part_City_01()
{
	...
	Wld_InsertNpc(VLK_499_Buerger, "NW_CITY_ENTRANCE_01"); // OV-BÃƒÂ¼rger. IÃƒÅ¸t an Stand, Smalltalk im OV, pennt iv ??? (OV)
	Wld_InsertNpc(VLK_416_Matteo, "NW_CITY_ENTRANCE_01"); // AusrÃƒÂ¼stungs-HÃƒÂ¤ndler, pennt in NW_City_Bed_Matteo
	...
	Wld_InsertNpc(VLK_426_Buergerin, "NW_CITY_ENTRANCE_01"); // ZuhÃƒÂ¶rerin, nachts vor Stadtkneipe
	Wld_InsertNpc(VLK_428_Buergerin, "NW_CITY_ENTRANCE_01"); // ZuhÃƒÂ¶rerin, nachts Smalltalk Bierstand
	Wld_InsertNpc(VLK_450_Buerger, "NW_CITY_ENTRANCE_01"); // ZuhÃƒÂ¶rer, nachts vor Stadtkneipe
	Wld_InsertNpc(VLK_454_Buerger, "NW_CITY_ENTRANCE_01"); // ZuhÃƒÂ¶rer, nachts an Blubber
	Wld_InsertNpc(VLK_455_Buerger, "NW_CITY_ENTRANCE_01"); // ZuhÃƒÂ¶rer, nachts Smalltalk Bierstand
	Wld_InsertNpc(VLK_421_Valentino, "NW_CITY_ENTRANCE_01"); // OV-BÃƒÂ¼rger,
	// ------------------------------
	...
	Wld_InsertNpc(VLK_456_Abuyin, "NW_CITY_ENTRANCE_01"); // Wasserpfeifen-HÃƒÂ¤ndler, pennt in Hotel
	...
	// ---Marktplatz--------------------
	Wld_InsertNpc(VLK_407_Hakon, "NW_CITY_ENTRANCE_01"); // WaffenhÃƒÂ¤ndler, nachts in Hotel
	Wld_InsertNpc(VLK_408_Jora, "NW_CITY_ENTRANCE_01"); // KrÃƒÂ¤mer, nachts in Hotel
	Wld_InsertNpc(VLK_409_Zuris, "NW_CITY_ENTRANCE_01"); // TrankhÃƒÂ¤ndler, nachts in Zuris Haus
	Wld_InsertNpc(VLK_410_Baltram, "NW_CITY_ENTRANCE_01"); // LebensmittelhÃƒÂ¤ndler, nachts in Hotel
	Wld_InsertNpc(VLK_470_Sarah, "NW_CITY_ENTRANCE_01"); // WaffenhÃƒÂ¤ndlerin (Canthars Opfer), nachts in Hotel
	...
	Wld_InsertNpc(VLK_415_Meldor, "NW_CITY_ENTRANCE_01"); // Einer von Lehmars SchlÃƒÂ¤gern, pennt in hafen03
	...
	Wld_InsertNpc(VLK_479_Lucy, "NW_CITY_ENTRANCE_01"); // Alwins Frau, GÃƒÂ¤rtnerin, NW_City_Pick_02, pennt in hafen02
	...
	Wld_InsertNpc(VLK_453_Buerger, "NW_CITY_ENTRANCE_01"); // SÃƒÂ¤gt, pennt in hafen06
	Wld_InsertNpc(VLK_430_Buergerin, "NW_CITY_ENTRANCE_01"); // Frau vom SÃƒÂ¤ger, pennt in hafen 06

	// ---Forscher----------
	Wld_InsertNpc(VLK_498_Ignaz, "NW_CITY_ENTRANCE_01"); // verrÃƒÂ¼ckter Forscher, hafen09, lebt und pennt da

	// ---Platz E----------- (Edda)
	Wld_InsertNpc(VLK_471_Edda, "NW_CITY_ENTRANCE_01"); // Kocht fÃƒÂ¼r die Armen, pennt in hafen08 - NW_City_Habour_Poor_Area_Hut_06_Bed_02
	// Bett frei (Bed_01)

	// ---Platz F----------- (Fellan)
	Wld_InsertNpc(VLK_480_Fellan, "NW_CITY_ENTRANCE_01"); // irrer HÃƒÂ¤mmerer, pennt in FELLAN - NW_City_Habour_Hut_05_Bed_01
	Wld_InsertNpc(VLK_478_Buergerin, "NW_CITY_ENTRANCE_01"); // Fellans Frau, GÃƒÂ¤rtnerin, NW_City_Pick_01, pennt in FELLAN
	...
	Wld_InsertNpc(VLK_444_Jack, "NW_CITY_ENTRANCE_01"); // am Kai, wartet, daÃƒÅ¸ der Leuchtturm frei wird
	...
	Wld_InsertNpc(VLK_434_Borka, "NW_CITY_ENTRANCE_01"); // TÃƒÂ¼rsteher Puff 24h
	...
	Wld_InsertNpc(VLK_476_Fenia, "NW_CITY_ENTRANCE_01"); // Halvors Frau, HÃƒÂ¤ndlerin auf Hafenstrasse, pennt in FISCH
	...
	Wld_InsertItem(ItMi_Moleratlubric_MIS, "FP_ITEM_SHIP_07"); // zur Sicherheit fÃƒÂ¼r Vinos Brennerei!
	...
	Wld_InsertNpc(Mil_313_Boltan, "NW_CITY_ENTRANCE_01"); // GefÃƒÂ¤ngniswÃƒÂ¤rter
	...
	// Wld_InsertNpc(VLK_463_Buerger, "NW_CITY_ENTRANCE_01"); // SMALLTALK GEMÃƒÅ“SE
	// Wld_InsertNpc(VLK_464_Buerger, "NW_CITY_ENTRANCE_01"); // SMALLTALK GEMÃƒÅ“SE
	// Wld_InsertNpc(VLK_465_Buerger, "NW_CITY_ENTRANCE_01"); // DRINKING GEMÃƒÅ“SE

	// Wld_InsertNpc(VLK_483_Buergerin, "NW_CITY_ENTRANCE_01"); // SMALLTALK GEMÃƒÅ“SE
	// Wld_InsertNpc(VLK_490_Buergerin, "NW_CITY_ENTRANCE_01"); // SMALLTALK GEMÃƒÅ“SE

	// Wld_InsertNpc(VLK_4200_Buergerin, "NW_CITY_ENTRANCE_01"); // Smalltalk

	// ADDON>
	// Piratenlager an der KÃƒÂ¼ste
	...
	// ---oberes Viertel-------------------
	// ------------------------------------
	Wld_InsertNpc(Mil_304_Torwache, "NW_CITY_ENTRANCE_01"); // Torwache BÃƒÂ¼rgerviertel 24h
	Wld_InsertNpc(Mil_305_Torwache, "NW_CITY_ENTRANCE_01"); // Torwache BÃƒÂ¼rgerviertel Important 24h
	// ------------------------------------
...
func void STARTUP_NewWorld_Part_Monastery_01()
{
	...
	Wld_InsertNpc(NOV_601_Igaraz, "NW_MONASTERY_ENTRY_01"); // ErwÃƒÂ¤hlter im Smalltalk im Hof
	Wld_InsertNpc(NOV_603_Agon, "NW_MONASTERY_ENTRY_01"); // KrÃƒÂ¤utergarten
	Wld_InsertNpc(NOV_604_Dyrian, "NW_MONASTERY_ENTRY_01"); //
	Wld_InsertNpc(NOV_605_Opolos, "NW_MONASTERY_ENTRY_01"); // HÃƒÂ¼tet Schafe
...
func void INIT_SUB_NewWorld_Part_Monastery_01()
{
	...
	Wld_AssignRoomToGuild("kloster02", GIL_PUBLIC); // BÃƒÂ¼cherei
...
func void STARTUP_NewWorld_Part_GreatPeasant_01()
{
	...
	// ------ FeldrÃƒÂ¤uberhÃƒÂ¶hle ------

	// 3 rausgenommen, wegen Fester-> werden spÃƒÂ¤ter insertet
...
func void INIT_SUB_NewWorld_Part_GreatPeasant_01()
{
	...
	Wld_AssignRoomToGuild("grpwaldhuette02", GIL_PUBLIC); // BanditenhÃƒÂ¼tte
};
...
func void STARTUP_NewWorld_Part_Forest_01()
{
	...
	// Beim ersten HÃƒÂ¤ndlerÃƒÂ¼berfall
...
func void STARTUP_NewWorld_Part_TrollArea_01()
{
	...
	*/
	...
	// in der Maya-HÃƒÂ¶hle

	// Gobbos in EingangshÃƒÂ¶hle
...
func void INIT_NewWorld()
{
	...
	if ((MIS_ReadyForChapter3 == TRUE) // Joly: muÃƒÅ¸ hier in der INIT ganz zum schluss stehen, nachdem alle NSCs fÃƒÂ¼rs Kapitel insertet wurden!!!
	...
	if ((MIS_AllDragonsDead == TRUE) // Joly: muÃƒÅ¸ hier in der INIT ganz zum schluss stehen, nachdem alle NSCs fÃƒÂ¼rs Kapitel insertet wurden!!!
...
func void STARTUP_AddonWorld()
{
	...
	CurrentLevel = ADDONWORLD_ZEN;
	Wld_SetTime(60, 00); // Joly: KDW sind schon 2 Tag da. SC hat ein biosschen lÃƒÂ¤nger gebraucht.
};
