...
// *****************************************************************************************
	...
	const string MOBNAME_ANVIL							= "Anvil";								// Amboss
	const string MOBNAME_BUCKET							= "Water Bucket";						// Wassereimer
	const string MOBNAME_FORGE							= "Forge Fire";						// Schmiede
	...
	const string MOBNAME_PAN							= "Pan";								// Lagerfeuer mit Pfanne
	const string MOBNAME_REPAIR							= "";									// Repair Mobsi
	const string MOBNAME_WATERPIPE						= "Water Pipe";						// Blubber
	const string MOBNAME_SWITCH							= "Switch";							// alle Schalter
	const string MOBNAME_ORE							= "Lump of Ore";							// Erzmobsi
...
// Ladenschilder
	...
	const string MOBNAME_TAVERN_01						= "The Dead Harpy";
	const string MOBNAME_SALANDRIL						= "Salandril's Potions";
...
// Grabsteine
	...
	const string MOBNAME_GRAVE_16						= "Ernesto Ortoj 350 - 410 'I will always be with you'";
...
// Paladin Runen
	...
	const string NAME_SPL_PalFullHeal					= "Total Healing";
...
// ***************************************************************************************
	...
	const string NAME_Halsabschneider					= "Cutthroat";
...
//**************************************************
	...
	const string NAME_Addon_Pirat						= "Pirate";								// _addon_ ?
...
// ADDON
	...
	const string NAME_ADDON_WISPSKILL_POTIONS			= "Potions, Magic and Regular";
...
// *************************************************************
	...
	const string NAME_Addon_Harad_01					= "Fine Sword";						// ItMw_Schwert1 (60/50)
	const string NAME_Addon_Harad_02					= "Fine Longsword";					// ItMw_Schwert4 (80/70)
	const string NAME_Addon_Harad_03					= "Ruby Blade";						// ItMw_Rubinklinge (100/90)
...
// ------ Diebestalente --------------------------------------------------------------------------
	...
	const string PRINT_Beliarshitpoints_MAX				= "Life energy -";

// ------ Player Talents -------------------------------------------------------------------------
	const string PRINT_LearnSmith						= "Learn: Forge weapon";
	const string PRINT_LearnRunes						= "Learn: Create rune";
	const string PRINT_LearnAlchemy						= "Learn: Brew potion";
	...
	const string PRINT_LearnForeignLanguage				= "Learn: Language of the builders";			// ADDON
	const string PRINT_LearnWispDetector				= "Your will-o'-the-wisp has learned";			// ADDON
...
// -------- Lern Konstanten der Descriptions ---------------------------------------------------
	...
	const string PRINT_LearnSTR10						= "Strength + 10";
	const string PRINT_LearnSTR20						= "Strength + 20";

	const string PRINT_LearnDEX1						= "Dexterity + 1";
	const string PRINT_LearnDEX5						= "Dexterity + 5";
	const string PRINT_LearnDEX10						= "Dexterity + 10";
	const string PRINT_LearnDEX20						= "Dexterity + 20";

	const string PRINT_LearnMANA1						= "Mana + 1";
	const string PRINT_LearnMANA5						= "Mana + 5";
	const string PRINT_LearnMANA10						= "Mana + 10";
	const string PRINT_LearnMANA20						= "Mana + 20";
	...
	const string PRINT_Learn1h20						= "One-handed weapons + 20";
	...
	const string PRINT_Learn2h20						= "Two-handed weapons + 20";

	const string PRINT_LearnBow1						= "Bow + 1";
	const string PRINT_LearnBow5						= "Bow + 5";
	const string PRINT_LearnBow10						= "Bow + 10";
	const string PRINT_LearnBow20						= "Bow + 20";

	const string PRINT_LearnCrossBow1					= "Crossbow + 1";
	const string PRINT_LearnCrossBow5					= "Crossbow + 5";
	const string PRINT_LearnCrossBow10					= "Crossbow + 10";
	const string PRINT_LearnCrossBow20					= "Crossbow + 20";
	...
	const string NAME_LEARN_SNEAK						= "Teach me how to sneak around!";
	const string NAME_LEARN_LOCKS						= "Teach me how to pick a lock!";
	const string NAME_LEARN_SMITHING					= "Learn to forge";
	const string NAME_LEARN_SMITHING2					= "Show me how I can forge a good sword!";
	const string NAME_LEARN_CLAWS						= "Remove claws";
	const string NAME_LEARN_TEETH						= "Remove teeth";
	const string NAME_LEARN_TEETH1						= "Pull teeth";
	const string NAME_LEARN_MANDIBLES					= "Remove mandibles";
	const string NAME_LEARN_FUR							= "Skin";
	const string NAME_LEARN_SKIN						= "Skin animals";
	const string NAME_LEARN_HEARTS						= "Remove hearts";
	const string NAME_LEARN_HEART						= "Remove heart";
	const string NAME_LEARN_BLOODFLY_STING				= "Bloodfly's stinger";
	const string NAME_LEARN_BLOODFLY_WING				= "Bloodfly's wings";
	const string NAME_LEARN_CRAWLER_PLATES				= "Remove crawler plates";
	const string NAME_LEARN_CRAWLER_PLATES_2			= "Teach me how to take the plates off crawlers!";
	const string NAME_LEARN_SHADOWBEAST_HORN			= "Shadowbeast horn";
	const string NAME_LEARN_FIRE_TONGUE					= "Tongue of fire";
	const string NAME_LEARN_DRAGON_SNAPPER_HORN			= "Dragon snapper horn";
	const string NAME_LEARN_DRAGON_SCALES				= "Remove dragon scales";
	const string NAME_LEARN_DRAGON_BLOOD				= "Collect dragon blood";
	const string NAME_LEARN_REPEL_EVIL					= "Expel evil";
	const string NAME_LEARN_REPEL_EVIL2					= "Damage Evil";
	const string NAME_LEARN_TEACH_ME					= "Teach me.";
...
// Potion constants
	...
	const string	NAME_HealthPotion1					= "Essence of Healing";
	const string	NAME_HealthPotion2					= "Extract of Healing";
	const string	NAME_HealthPotion3					= "Elixir of Healing";
	const string	NAME_HealthPermanent				= "Elixir of Life";

	const string	NAME_ManaPotion1					= "Mana Essence";
	const string	NAME_ManaPotion2					= "Mana Extract";
	const string	NAME_ManaPotion3					= "Mana Elixir";
	const string	NAME_ManaPermanent					= "Elixir of Spirit";

	const string	NAME_Dex_Permanent					= "Elixir of Dexterity";
	const string	NAME_Str_Permanent					= "Elixir of Strength";
	const string	NAME_Speed_Potion					= "Speed Potion";

// Monster names

	const string NAME_STONE_GOLEM						= "Stone Golem";

	const string NAME_TALENT_SNEAK						= "Sneak";
	const string NAME_TALENT_PICKPOCKET					= "Pickpocket";
	const string NAME_TALENT_PICKLOCK					= "Pick Locks";
...
// ************************************
	...
	const string PRINT_Addon_Joint_01_Success			= "Green novice rolled!";				// ADDON
...
// ------ spezielle -------
	const string PRINT_GornsTreasure					= "100 gold received.";
	const string PRINT_KerolothsGeldBeutel				= "300 gold received.";
	const string PRINT_MalethBanditsGold				= "300 gold received.";
	const string Print_DiegosTreasure					= "2000 gold received.";
	...
	const string Print_InnosEyeLoad						= "Auge aufladen";

	const string PRINT_GotFourItems						= "4 items received";
...
// ----------- Items in Items finden --------------------
	...
	const string PRINT_FoundRing						= "Ring found";
	const string PRINT_FoundAmulett						= "Amulet found";
	const string PRINT_FoundScroll						= "Spell scroll found";
	const string PRINT_FoundPotion						= "Potion found";
	const string PRINT_FoundMap							= "Map found";

	const string PRINT_FoundGold10						= "10 gold found";
	const string PRINT_FoundGold25						= "25 gold found";
	const string PRINT_FoundGold50						= "50 gold found";
	const string PRINT_FoundGold100						= "100 gold found";
...
// ***************************************************************************************
	...
	const string PRINT_LevelUp							= "Level Up!";					// beim Stufenaufstieg
...
// ------ Goldhacken ------
	const string PRINT_NUGGETS_0						= "Nothing...";
	const string PRINT_NUGGETS_1						= "1 gold nugget mined!";
	const string PRINT_NUGGETS_2						= "2 gold nuggets mined!";
	const string PRINT_NUGGETS_3						= "3 gold nuggets mined!";
	const string PRINT_NUGGETS_MISSED					= "Gold splinters fly everywhere...";
	const string PRINT_NUGGETS_NOTHING					= "There's nothing else to be had here.";

	const string PRINT_GOLD_BEGINNER					= "an absolute beginner (";
	const string PRINT_GOLD_SCRAPER						= "a quite passable scraper (";
	const string PRINT_GOLD_BETTER_SCRAPER				= "an experienced gold scraper (";
	const string PRINT_GOLD_DIGGER						= "a genuine digger (";
	const string PRINT_GOLD_BETTER_DIGGER				= "a damned good digger (";
	const string PRINT_GOLD_MASTER_DIGGER				= "a master digger (";
	const string PRINT_GOLD_GURU_DIGGER					= "a guru among diggers (";
	const string PRINT_GOLD_PERCENT_BRACKET				= " percent)";
	const string PRINT_GOLD_SKILL						= "Gold mining: ";
	const string PRINT_GOLD_PERCENT						= " percent";

// Item messages
	const string PRINT_STR_HP_BONUS						= "Strength and life energy increased!";
	const string PRINT_FRANCIS_CHEST					= "Received a pile of stuff!";

// Potion hotkey messages
	const string PRINT_NO_MANA_POTIONS					= "No mana potions available!";
	const string PRINT_MANA_ALREADY_MAX					= "Max. mana already reached!";
	const string PRINT_NO_HP_POTIONS					= "No healing potions available!";
	const string PRINT_HP_ALREADY_MAX					= "Maximum Hitpoints already reached!";

// Items given prints
	const string PRINT_GIVE_RAW_MEAT					= " Raw Meat given";
	const string PRINT_GIVE_COOKED_MEAT					= " Fried Meat given";
	const string PRINT_GIVE_HAM							= " Ham given";
	const string PRINT_GIVE_SAUSAGE						= " Sausages given";
	const string PRINT_GIVE_TOTAL_MEAT					= "Total Meat given: ";

	const string PRINT_GIVE_HONEY						= "Honey given";
	const string PRINT_GIVE_BREAD						= "Bread given";
	const string PRINT_GIVE_WURST						= "Sausage given";
	const string PRINT_GIVE_WEIN						= "Wine given";
	const string PRINT_GIVE_CONSTANTINO_PLANTS			= "11 items given (plants)";
