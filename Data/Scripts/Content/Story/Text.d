...
// *****************************************************************************************
	...
	const string MOBNAME_BOOKSTAND						= "Buchständer";						// Buchständer
...
// Teleport Runen
	...
	const string NAME_SPL_TeleportOWDemonTower			= "Teleport zum alten Dämonenturm";
...
// ***************************************************************************************
	...
	const string NAME_Tuerwache							= "Türwache";
	...
	const string NAME_Buergerin							= "Bürgerin";
	...
	const string NAME_Baeuerin							= "Bäuerin";
...
// *************************************************************
	...
	const string PRINT_ItemsGegeben						= " Gegenstände gegeben";
	...
	const string PRINT_ItemsErhalten					= " Gegenstände erhalten";
...
// -------- Lern Konstanten der Descriptions ---------------------------------------------------
	...
	const string PRINT_LearnSTR10						= "Stärke + 10";
	const string PRINT_LearnSTR20						= "Stärke + 20";

	const string PRINT_LearnDEX1						= "Geschicklichkeit + 1";
	const string PRINT_LearnDEX5						= "Geschicklichkeit + 5";
	const string PRINT_LearnDEX10						= "Geschicklichkeit + 10";
	const string PRINT_LearnDEX20						= "Geschicklichkeit + 20";
	...
	const string PRINT_Learn1h10						= "Einhand - Waffen + 10";
	const string PRINT_Learn1h20						= "Einhand - Waffen + 20";

	const string PRINT_Learn2h1							= "Zweihand - Waffen + 1";
	const string PRINT_Learn2h5							= "Zweihand - Waffen + 5";
	const string PRINT_Learn2h10						= "Zweihand - Waffen + 10";
	const string PRINT_Learn2h20						= "Zweihand - Waffen + 20";

	const string PRINT_LearnBow1						= "Bogen + 1";
	const string PRINT_LearnBow5						= "Bogen + 5";
	const string PRINT_LearnBow10						= "Bogen + 10";
	const string PRINT_LearnBow20						= "Bogen + 20";

	const string PRINT_LearnCrossBow1					= "Armbrust + 1";
	const string PRINT_LearnCrossBow5					= "Armbrust + 5";
	const string PRINT_LearnCrossBow10					= "Armbrust + 10";
	const string PRINT_LearnCrossBow20					= "Armbrust + 20";
...
// Monster names
	...
	const string NAME_TALENT_SNEAK						= "Schleichen";
	const string NAME_TALENT_PICKPOCKET					= "Taschendiebstahl";
	const string NAME_TALENT_PICKLOCK					= "Schlösser knacken";
...
// *************************************
	...
	const string PRINT_BlessSTR							= "Innos schenkt dir: Stärke + ";
...
// ---------- Dialoge Banditenlager -----------------
	const string DIALOG_ADDON_ATTENTAT_DESCRIPTION		= "Was weißt du über das Attentat gegen Esteban?";
...
// ------ spezielle -------
	...
	const string PRINT_NumberLeft						= "  übrig";
	const string PRINT_NovizenLeft						= "  Novizen übrig";

// ------ Addon-----
	const string PRINT_Addon_CanyonRazorsLeft			= "  Razor übrig";
// -----------------
...
// ------ Goldhacken ------
	const string PRINT_NUGGETS_0						= "Nichts ...";
	const string PRINT_NUGGETS_1						= "1 Goldbrocken gehackt! ...";
	const string PRINT_NUGGETS_2						= "2 Goldbrocken gehackt! ...";
	const string PRINT_NUGGETS_3						= "3 Goldbrocken gehackt! ...";
	const string PRINT_NUGGETS_MISSED					= "Goldsplitter fliegen durch die Gegend ...";
	const string PRINT_NUGGETS_NOTHING					= "Hier gibt's Nichts mehr zu holen.";

	const string PRINT_GOLD_BEGINNER					= "blutiger Anfänger (";
	const string PRINT_GOLD_SCRAPER						= "ganz passabler Schürfer (";
	const string PRINT_GOLD_BETTER_SCRAPER				= "erfahrener Goldschürfer (";
	const string PRINT_GOLD_DIGGER						= "waschechter Buddler ( ";
	const string PRINT_GOLD_BETTER_DIGGER				= "verdammt guter Buddler ( ";
	const string PRINT_GOLD_MASTER_DIGGER				= "Meister Buddler ( ";
	const string PRINT_GOLD_GURU_DIGGER					= "Buddler Guru ( ";
	const string PRINT_GOLD_PERCENT_BRACKET				= " Prozent)";
	const string PRINT_GOLD_SKILL						= "Goldhacken: ";
	const string PRINT_GOLD_PERCENT						= " Prozent";

// Item messages
	const string PRINT_STR_HP_BONUS						= "Stärke und Lebensenergie gesteigert!";
	const string PRINT_FRANCIS_CHEST					= "Einen Haufen Zeug erhalten!";
...
// Items given prints
	const string PRINT_GIVE_RAW_MEAT					= " Rohes Fleisch gegeben";
	const string PRINT_GIVE_COOKED_MEAT					= " Gebratenes Fleisch gegeben";
	const string PRINT_GIVE_HAM							= " Schinken gegeben";
	const string PRINT_GIVE_SAUSAGE						= " mal Wurst gegeben";
	const string PRINT_GIVE_TOTAL_MEAT					= "Insgesamt Fleisch gegeben: ";

	const string PRINT_GIVE_HONEY						= "Honig gegeben";
	const string PRINT_GIVE_BREAD						= "Brot gegeben";
	const string PRINT_GIVE_WURST						= "Wurst gegeben";
	const string PRINT_GIVE_WEIN						= "Wein gegeben";
	const string PRINT_GIVE_CONSTANTINO_PLANTS			= "11 Gegenstände gegeben (Pflanzen)";
