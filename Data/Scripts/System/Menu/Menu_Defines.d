...
//
	...
	const string MENU_ITEM_BACK_PIC 	= "";						// Hintergrund fÃƒÂ¼r alle anwÃƒÂ¤hlbaren MenÃƒÂ¼punkte
	const string MENU_CHOICE_BACK_PIC	= "menu_choice_back.tga";	// Hintergrund fÃƒÂ¼r Choicebox
	const string MENU_SLIDER_BACK_PIC	= "menu_slider_back.tga";	// Hintergrund fÃƒÂ¼r Slider
	const string MENU_SLIDER_POS_PIC	= "menu_slider_pos.tga";	// Textur fÃƒÂ¼r Positionsanzeige eines Sliders
	const string MENU_INPUT_BACK_PIC 	= "";						// Hintergrund fÃƒÂ¼r Eingabefelder
	const string MENU_KBDINPUT_BACK_PIC = "";						// Hintergrund fÃƒÂ¼rs Definieren der Controls
	const string MENU_SAVELOAD_BACK_PIC = "menu_saveload_back.tga"; // menu_kbd_back.tga";		// Hintergrund fÃƒÂ¼rs Definieren der Controls
	// Log
	const string LOG_BACK_PIC			= "log_back.tga";			// Hintergrund fÃƒÂ¼r den Log-Screen
